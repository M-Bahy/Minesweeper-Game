...
down (Null) = Null
down (S (x,y) (h:t) z c ) = if (x==3) then Null else (S (x+1,y) (h:t) "down" (S (x,y) (h:t) z c ) )

right:: MyState -> MyState
right (Null) = Null
right (S (x,y) (h:t) z c ) = if (y==3) then Null else (S (x,y+1) (h:t) "right" (S (x,y) (h:t) z c ) )
...
collect (Null) = Null
collect (S (x,y) (h:t) z c ) = if elem (x,y) (h:t) then (S (x,y) (removeItem (x,y) (h:t)) "collect" (S (x,y) (h:t) z c ) ) else Null
